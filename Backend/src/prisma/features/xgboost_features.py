...
from prisma.features.market_features import MarketFeatureExtractor, MARKET_FEATURE_NAMES
...
def _extract_features_list(data: dict, conn=None) -> list:
    ...
    if conn and 'session_id' in data and 'equipe_dom_id' in data:
        try:
            ...
            try:
                from prisma.features.team_strength_matrix import get_relative_strength
            except ImportError:
